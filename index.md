...
<body>
	<nav>
		<div>
			<a href="#layer-main"><img src="img/manga.png">
			<h3>Mangulice</h3></a>
			...
			<p><span style="font-size: 10px;">Logo created and designed using Logomakr.com</span> <br>Srbislav Vučenović 2020. &copy</p>
		</div>
	</nav>
	<main>
		<img src="img/menu.png">
		<div id="layer-main">
			<div id="layer-main-content">
				<h2>Dobrodošli!</h2>
				<p>Saznajte više o mangulicama i posjetite nas kako bi kupili koju ;) </p>
			</div>
		</div>
		<div id="about">
			<h1>O mangulicama</h1>
